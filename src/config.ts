 ...
 *
 * Prefer editing `sumi.config.ts` instead of this file. This module exists to
 * apply defaults and expose a fully-resolved config shape (`ResolvedSumiConfig`).
 */
import userConfig from "@/sumi.config";
